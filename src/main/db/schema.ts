...
ALTER TABLE articulos ADD COLUMN IF NOT EXISTS desc2_pct NUMERIC(6,2) NOT NULL DEFAULT 0;
ALTER TABLE articulos ADD COLUMN IF NOT EXISTS desc3_pct NUMERIC(6,2) NOT NULL DEFAULT 0;
ALTER TABLE articulos ADD COLUMN IF NOT EXISTS desc4_pct NUMERIC(6,2) NOT NULL DEFAULT 0;
ALTER TABLE articulos ADD COLUMN IF NOT EXISTS desc5_pct NUMERIC(6,2) NOT NULL DEFAULT 0;
ALTER TABLE articulos ADD COLUMN IF NOT EXISTS ganancia_pct NUMERIC(6,2) NOT NULL DEFAULT 0;
ALTER TABLE articulos ADD COLUMN IF NOT EXISTS en_oferta_mayor INTEGER NOT NULL DEFAULT 0;
ALTER TABLE articulos ADD COLUMN IF NOT EXISTS en_oferta_mostrador INTEGER NOT NULL DEFAULT 0;
ALTER TABLE articulos ADD COLUMN IF NOT EXISTS desc_oferta_mayor_pct NUMERIC(6,2) NOT NULL DEFAULT 0;
ALTER TABLE articulos ADD COLUMN IF NOT EXISTS desc_oferta_mostrador_pct NUMERIC(6,2) NOT NULL DEFAULT 0;
